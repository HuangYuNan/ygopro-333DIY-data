...
function c1000606.spfilter(c,e,tp)
	return c:IsSetCard(0xc204) and c:IsType(TYPE_FUSION+TYPE_SYNCHRO) and c:IsCanBeSpecialSummoned(e,0,tp,true,false)
end
...
function c1000606.filter1(c)
	return c:IsFaceup() and c:IsSetCard(0xc204) and c:GetCode()~=1000606
end
