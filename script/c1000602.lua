...
function c1000602.costfilter(c)
	return c:IsSetCard(0xc204) and c:IsType(TYPE_MONSTER) and c:IsDiscardable()
end
...
function c1000602.filter(c,e,tp)
	return c:IsSetCard(0xc204) and not c:IsType(TYPE_TUNER) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
...
function c1000602.tgfilter(c)
	return c:IsSetCard(0xc204) and not c:IsType(TYPE_TUNER) and c:IsType(TYPE_MONSTER) and c:IsAbleToGrave()
end
