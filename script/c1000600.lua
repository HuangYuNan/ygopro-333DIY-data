...
function c1000600.filter(c,e,tp)
	return ((c:IsType(TYPE_TUNER) and c:IsSetCard(0xc204)) or c:IsSetCard(0x5b23)) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
...
function c1000600.con(e,tp,eg,ep,ev,re,r,rp)
   local g=Duel.GetMatchingGroup(Card.IsSetCard,e:GetHandlerPlayer(),LOCATION_GRAVE,0,nil,(0xc204 or 0x5b23))
