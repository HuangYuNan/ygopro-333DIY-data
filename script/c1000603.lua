...
function c1000603.costfilter(c)
	return c:IsDiscardable() and c:IsSetCard(0xc204)
end
...
function c1000603.sefilter(c)
	return c:IsSetCard(0xc204)  and c:IsAbleToHand() and  c:IsType(TYPE_MONSTER)
end
...
function c1000603.spfilter(c,e,tp)
	return c:IsSetCard(0xc204) and c:IsType(TYPE_TUNER) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
...
function c1000603.cfilter(c,tp)
	return c:IsSetCard(0xc204) and c:IsReason(REASON_DESTROY)
